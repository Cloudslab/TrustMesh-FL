...
\midrule
BlockFL~\cite{kim2020blockchained}   & Each device, off-chain & None (ledger record only) & Miner cross-verification & Honest miner majority \\
BFLC~\cite{li2021bflc}               & Elected committee & Committee consensus & Committee update scoring & Honest committee majority \\
...
\tmfl{} (this work)                  & All PBFT validators & Re-execution + model validation & 4-stage validation pipeline & $\leq f$ of $3f{+}1$ validators faulty \\
\bottomrule
\end{tabular}
\vspace{2pt}
